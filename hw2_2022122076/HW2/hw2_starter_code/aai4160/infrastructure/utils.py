...
#         steps += 1
#         rollout_done: bool = (done==True) or (steps>=max_length) # HINT: this is either 0 or 1
#         if(done) : 
#             print("step is")
#             print(steps)
...
#             break
        ...
        obs.append(ob)
        ac:np.ndarray = policy.get_action(ob) # HINT: query the policy's get_action function
        ac = ac[0]
        acs.append(ac)
