...
class CQLCritic(BaseCritic):
    ...
    def update(self, ob_no, ac_na, next_ob_no, reward_n, terminal_n):
        ...
        dqn_loss,q_all_values,q_estimate_values=self.dqn_loss(ob_no,ac_na,next_ob_no,reward_n,terminal_n)
        q_t_logsumexp=torch.logsumexp(q_all_values,dim=1)
        cql_loss=torch.mean(q_t_logsumexp-q_estimate_values)
        ...
        info['Data q-values'] = ptu.to_numpy(q_estimate_values).mean()
